...
## one line — the value, in plain words

Hein Thaw · https://github.com/heinthaw-dev · vibecode.tours

---

# What you get

- **Outcome 1** — the win for the user
- **Outcome 2**
- **Outcome 3**
...
- **Repo:** https://github.com/heinthaw-dev/blood-help · **License:** MIT
