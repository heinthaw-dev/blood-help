...
The keys live in `.claude/settings.json` (project) or `/Users/bhoneak/Desktop/Learning/VibeCodeTour/blood-help/.claude/settings.json` (global) — **not** in `.planning/config.json`:
