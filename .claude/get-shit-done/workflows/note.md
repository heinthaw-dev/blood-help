...
- **Global scope**: `/Users/bhoneak/Desktop/Learning/VibeCodeTour/blood-help-old/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/bhoneak/Desktop/Learning/VibeCodeTour/blood-help-old/.claude/notes/`)
...
2. Glob `/Users/bhoneak/Desktop/Learning/VibeCodeTour/blood-help-old/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/bhoneak/Desktop/Learning/VibeCodeTour/blood-help-old/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/bhoneak/Desktop/Learning/VibeCodeTour/blood-help-old/.claude/notes/` — works in any directory
