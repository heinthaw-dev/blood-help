...
const STRINGS: Record<
    Lang,
    { title: string; subtitle: string; cta: string; reassure: string }
> = {
    my: {
        title: "သင့်ဖုန်းနံပါတ်ကို ထည့်ပါ",
        subtitle:
            "သင့်ဖုန်းနံပါတ်ကို ထည့်ပါ။ ဝင်ရောက်ရန် ဂဏန်း ၆ လုံး ကုဒ်ကို SMS ဖြင့် ပို့ပေးပါမည်။",
        cta: "ကုဒ် ပို့ရန်",
        reassure:
    ...
    en: {
        ...
        subtitle:
            "We'll text you a 6-digit code to sign in — no password needed.",
        cta: "Send code",
        reassure:
            "Your number is only used to sign in and so donors can reach you.",
    },
};
