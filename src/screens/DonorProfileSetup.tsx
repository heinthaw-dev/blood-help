...
export function DonorProfileSetup({
    ...
    const strings = {
        my: {
            ...
            subtitle:
                "အနီးနားတွင် သင့်သွေးအုပ်စုနှင့် တူညီသောသူများ အကူအညီ လိုအပ်သည့်အခါ အကြောင်းကြားနိုင်ရန်အတွက် ဖြစ်ပါသည်။",
            nameLabel: "သင့်အမည်",
            ...
            deniedMsg:
                "တည်နေရာ ခွင့်ပြုချက် မရှိဘဲ ပရိုဖိုင် သိမ်းဆည်း၍ မရပါ။ ဘရောက်ဇာ ဆက်တင်တွင် တည်နေရာကို ဖွင့်ပြီး ထပ်ကြိုးစားပါ။",
