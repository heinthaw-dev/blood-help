 ...
 */
export function DonorCongrats({ lang, donationCount, onDone, onLeaderboard }: DonorCongratsProps) {
  ...
  const t = {
    my: {
      headline: 'ကျေးဇူးအများကြီး တင်ပါတယ်!',
      subheadline: 'သင်ဟာ အသက်တစ်ချောင်းကို ကယ်တင်ပေးခဲ့ပါတယ်။',
      supporting:
        'သင့်ရဲ့ သွေးလှူဒါန်းမှုက တစ်စုံတစ်ယောက်ရဲ့ ဘဝအတွက် အများကြီး အဓိပ္ပါယ်ရှိပါတယ်။ သင့်ရဲ့ ကြင်နာစေတနာအတွက် ကျေးဇူးတင်ပါတယ်။',
      milestoneLine: `${countFmt} ကြိမ်မြောက် လှူဒါန်းမှု ပြည့်ပါပြီ!`,
      countLine: `ဤသည် သင်၏ ${countFmt} ကြိမ်မြောက် လှူဒါန်းမှု ဖြစ်ပါတယ်။`,
      countSub: `This is your ${ordinal(donationCount)} donation.`,
      done: 'ပြီးပါပြီ',
      leaderboard: 'ထိပ်တန်းစာရင်း ကြည့်ရန်',
    },
    en: {
  ...
  return (
    ...
    <div className="phone-entry-card" style={{ fontFamily: bodyFont }}>
      ...
      >
        ...
        <div aria-hidden="true" style={{ position: 'relative', flex: 'none', marginBottom: '30px' }}>
          <div
            className="bh-motif"
            style={{
              width: '128px',
          ...
          >
            <svg width="60" height="60" viewBox="0 0 24 24" fill="none" style={{ display: 'block' }}>
              <path
          ...
          <Sparkle size={16} style={{ position: 'absolute', top: '6px', right: '8px', color: 'var(--color-primary)' }} />
          <Sparkle size={11} style={{ position: 'absolute', bottom: '10px', left: '2px', color: 'var(--color-primary)', animationDelay: '160ms' }} />
          <Sparkle size={8} style={{ position: 'absolute', top: '18px', left: '-6px', color: 'var(--color-primary)', animationDelay: '300ms' }} />
        </div>
        ...
        {isMilestone && (
          ...
          >
            ...
            <span style={{ fontFamily: bodyFont, fontSize: '13px', fontWeight: 600, lineHeight: 1.3 }}>
              {s.milestoneLine}
            </span>
          </div>
        )}
      ...
      >
        ...
        <button
          ...
          style={{
            ...
            fontSize: '14px',
            fontWeight: 600,
            color: lbHover ? 'var(--color-primary)' : 'var(--text-secondary)',
